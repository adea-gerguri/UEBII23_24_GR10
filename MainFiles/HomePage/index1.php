...
<body>
  <div id="header"></div>
            ...
            <div style="z-index: 0;" id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                  ...
                  <div class="carousel-item active item1" style="position: relative;">
                    ...
                    <div class="carousel-caption d-none d-md-block" style="position: absolute; top: 80%; left: 50%; transform: translate(-50%, -50%);">
    ...
    <p id="reklama">Dior and more...</p>
      ...
      <div id="video-container">
        <video title="Click to hear the sound !" id="myVideo" autoplay muted loop>
            <source src="../HomePage/INSILENCE 2023 SPRING_SUMMER Campaign Film.mp4" type="video/mp4">
...
<table class="fnd">
  <tr>
    <td class="firstTableRow">
      ...
      <h2 class="ff">Help</h2>
      <a href="#" class="help">Our Client Services are available for call from<br> 9 AM to 6 PM Monday to Thursday.</a>
      <a href="#" class="help">Email Services are available 24/7</a>
        <a href="tel:0800100" class="help">CONTACT US: 0800100</a>
      <br>
    ...
    <td class="secondRow">
      <h2 class="ff">About Us & Partners</h2>
      ...
      <a href="https://www.balenciaga.com/en-en" class="about" target="_blank">Balenciaga</a>
    </td>
...
<a href="#" class="scrollup" id="scroll-up">
  <i style="align-items: center;" class="ri-arrow-up-line"></i>
</a>
...
<script src="../HeaderFooter/footerStyle.js"></script>
  ...
  <script src="..//HomePage/video.js" ></script>
  <script src="..//HomePage/draganddrop.js"></script>
</body>
</html>
